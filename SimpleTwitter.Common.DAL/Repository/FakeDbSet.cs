...
{
    /// <summary>
    /// This is an in-memory, List backed implementation of  Entity Framework's System.Data.Entity.IDbSet to use for testing.
    /// </summary>
    ...
    public class FakeDbSet<T> : IDbSet<T> where T : class, IEntity
    {
        ...
        {
            if (keyValues.Length == 1 && keyValues[0] is Guid)
            {
                return _data.Find(e => e.Id == (Guid)keyValues[0]);
                //return _data.Find(e => e.GetPrimaryKey() == keyValues[0]);
            }
